...
function movie1(name, releaseDate) {
...
function movie(name, releaseDate = 2024) {
...
const sayHello3 = (userName, age) => console.log(`Hello World Dear ${userName} ${age}`);
