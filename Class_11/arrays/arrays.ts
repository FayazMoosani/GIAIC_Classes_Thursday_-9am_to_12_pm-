...
let students: string[] = ["Wajid", "Fayaz"];
let students1: (string | number)[] = ["Fayaz", 786, "Wajid", 786];
let students2: (string | number | boolean)[] = ["Death", 786, true, "World", 86, false];
console.log(students1);
console.log(students2);

// Accessing array elements by index
let newArryas: string[] = ["Maria", "Fayaz"];
