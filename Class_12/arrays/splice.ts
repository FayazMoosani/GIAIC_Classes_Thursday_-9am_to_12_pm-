...
// Tuples: Define fixed-size arrays with specific data types
type frt1 = [string, string, string, string];
const frt: frt1 = ["Apple", "Banana", "Mango", "Watermelon"]; // Fixed-size array with specific string data types
...
type MultiArrays = [number, number, number, [string, string, string]];
let multiArrays3: MultiArrays = [100000, 150000, 330000, ["Civic", "Corolla", "Ferrari"]]; // Multi-dimensional array with mixed types
...
type Intersection = { name: string, class: string };
type Intersection1 = { age: number, bachNo: string };
let data: Intersection | Intersection1 = {
    name: "Fayaz Ahmed",
    class: "Thursday",
    age: 23,
    bachNo: "Quarter 01",
...
let numberss = 18749812 as number; // Type casting to number
console.log(numberss); // Output: 18749812

let num1 = 23847338913 as number; // Type casting to number
let num2 = "Fayaz" as string; // Type casting to string
